...
function ItemForm() {
  ...
  // Redirect to the dashboard after successful item creation
  useEffect(() => {
    if (isSuccess) {
      // Redirect to the dashboard if item creation was successful
      navigate("/");
    }
  }, [isSuccess, navigate]); // Only runs if isSuccess changes
